...
export const donateButtonClass =
  "inline-flex items-center justify-center gap-2 rounded-full border border-coffeeDark/40 bg-gradient-to-b from-coffee to-coffeeDark font-semibold text-coffeeInk shadow-[0_2px_10px_rgba(245,167,0,0.35)] transition hover:brightness-105 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-coffeeDark active:translate-y-px";
